...
**I am working on:**  
Testing the Previous and Next buttons and the scene counter.

**I expected:**  
Each click would move one scene at a time and update the counter.

**What happened instead:**  
The navigation and counter worked as expected.

**The exact error:**  
No console error appeared.

**What I already tried:**  
I changed “Scene” to “Report scene,” saved the file, refreshed the browser, and tested all four scenes.
